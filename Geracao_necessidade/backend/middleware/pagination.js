...
const applyPagination = async (req, res, baseQuery, countQuery, params = [], baseUrl) => {
  try {
    ...
    const { query: paginatedQuery, params: paginatedParams } = pagination.applyPagination(baseQuery, params);
    
    // Executar query paginada
    const items = await query(paginatedQuery, paginatedParams);
...
const createCountQuery = (baseQuery) => {
  ...
  // Criar query de contagem - usar subquery para garantir compatibilidade

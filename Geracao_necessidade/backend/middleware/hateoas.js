...
class HateoasHelper {
  ...
  generateDashboardLinks() {
    return {
      ...
      escolas: `${this.baseUrl}/escolas`,
      necessidades: `${this.baseUrl}/necessidades`,
      produtos: `${this.baseUrl}/produtos`,
      recebimentos: `${this.baseUrl}/recebimentos-escolas`,
      solicitacoes: `${this.baseUrl}/solicitacoes-manutencao`,
      medias: `${this.baseUrl}/medias-escolas`,
      registros: `${this.baseUrl}/registros-diarios`
    };
  }

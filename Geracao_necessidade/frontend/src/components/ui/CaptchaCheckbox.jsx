    ...
    <div className={`${className}`}>
      <div className="flex items-start space-x-3">
        <div
          ...
          className={`
            relative w-5 h-5 border-2 rounded cursor-pointer transition-all duration-200 flex items-center justify-center
            ${disabled 
      ...
      {showError && (
        <p className="text-sm text-red-600 mt-2 flex items-center animate-fadeIn">

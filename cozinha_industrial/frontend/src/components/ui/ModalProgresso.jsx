...
/**
 * Modal de Progresso - Componente padrão para exibir progresso de operações longas
 * 
 * @param {boolean} isOpen - Controla se o modal está aberto
 * @param {string} title - Título do modal (padrão: 'Processando...')
 * @param {number} progresso - Número de itens processados
 * @param {number} total - Total de itens a processar
 * @param {string} mensagem - Mensagem de status (padrão: 'Aguarde, processando registros...')
 */

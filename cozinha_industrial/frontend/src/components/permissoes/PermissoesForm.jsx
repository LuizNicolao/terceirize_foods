...
const PermissoesForm = ({ 
  ...
  const gruposTelas = {
    'Cadastros': [
      ...
      { key: 'unidades_escolares', label: 'Cozinha Industrial' },
      { key: 'produtos_origem', label: 'Produtos Origem' },
      { key: 'produtos_genericos', label: 'Produtos Genéricos' },
      { key: 'produtos_comerciais', label: 'Produtos Comerciais' },
      { key: 'almoxarifados', label: 'Almoxarifados' },

...
import { useAlmoxarifadosConsulta } from '../../hooks/useAlmoxarifadosConsulta';
import { AlmoxarifadosStats, AlmoxarifadosTable, AlmoxarifadoModal } from '../../components/almoxarifados';
import { Button, Pagination, CadastroFilterBar } from '../../components/ui';
import { ExportButtons } from '../../components/shared';

/**
 * Página de consulta de Almoxarifados
...
const Almoxarifados = () => {
  ...
  const handleViewAlmoxarifado = (almoxarifado) => {
    setSelectedAlmoxarifado(almoxarifado);
    setShowViewModal(true);
  };

  const handleCloseViewModal = () => {
    setSelectedAlmoxarifado(null);
    ...
    return (
      <div className="flex justify-center items-center h-screen bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">Carregando almoxarifados...</p>
          {!isConnected && (
  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      {/* Estatísticas */}
      <AlmoxarifadosStats stats={stats} />

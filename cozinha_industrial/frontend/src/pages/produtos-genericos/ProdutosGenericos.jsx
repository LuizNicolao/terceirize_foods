...
import { useProdutosGenericosConsulta } from '../../hooks/useProdutosGenericosConsulta';
import { ProdutosGenericosStats, ProdutosGenericosTable, ProdutoGenericoModal } from '../../components/produtos-genericos';
import { Button, Pagination, CadastroFilterBar } from '../../components/ui';
import { ExportButtons } from '../../components/shared';

/**
 * Página de consulta de Produtos Genéricos
 * Modo apenas leitura - dados consultados do sistema Foods
 */
const ProdutosGenericos = () => {
    ...
    return (
      <div className="flex justify-center items-center h-screen bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">Carregando produtos genéricos...</p>
          {!isConnected && (
  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      {/* Estatísticas */}
      <ProdutosGenericosStats estatisticas={stats} />
      ...
      <ProdutoGenericoModal
        ...
        produtoGenerico={selectedProduto}
        isViewMode={true}
        ...
        produtosOrigem={[]} // Para cozinha_industrial, não temos produtos origem carregados
...
export default ProdutosGenericos;

...
class UsuariosListController {
  ...
  static listarUsuarios = asyncHandler(async (req, res) => {
    ...
    // Buscar filiais vinculadas para cada usuário (temporariamente desabilitado)
    ...
    for (let usuario of usuarios) {
      ...
      //   [usuario.id]
      // );
      usuario.filiais = []; // Array vazio por enquanto
    }
  ...
  static buscarUsuarioPorId = asyncHandler(async (req, res) => {
    ...
    // Buscar filiais vinculadas ao usuário (temporariamente desabilitado)
    // TODO: Implementar quando a tabela filiais for criada
    // const filiais = await executeQuery(
    //   `SELECT f.id, f.filial, f.cidade, f.estado, f.codigo_filial
    //    FROM filiais f
  ...
  static buscarFiliaisUsuario = asyncHandler(async (req, res) => {
    ...
    // Buscar filiais vinculadas (temporariamente desabilitado)
    // TODO: Implementar quando a tabela filiais for criada
    // const filiais = await executeQuery(
    ...
    const data = res.addResourceLinks({
      usuario: usuario[0],
      filiais: [] // Array vazio por enquanto
    });

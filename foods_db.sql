...
CREATE TABLE `almoxarifado` (
  ...
  `tipo_vinculo` enum('filial','unidade_escolar') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'filial',
...
CREATE TABLE `calendario_dias_nao_uteis` (
  ...
  `observacoes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `tipo_destino` enum('global','filial','unidade') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'global',
  `filial_id` int DEFAULT NULL,
  `unidade_escolar_id` int DEFAULT NULL,
  `criado_em` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `atualizado_em` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
CREATE TABLE `ficha_homologacao` (
  ...
  `tipo` enum('NOVO_PRODUTO','REAVALIACAO') COLLATE utf8mb4_unicode_ci NOT NULL,
  `data_analise` date NOT NULL,
  `marca` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Nome da marca (texto livre)',
  ...
  `peso` enum('BOM','REGULAR','RUIM') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `peso_valor` decimal(10,3) DEFAULT NULL COMMENT 'Peso líquido em kg (preenchido automaticamente do produto genérico)',
  `peso_cru` enum('BOM','REGULAR','RUIM') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `peso_cru_valor` decimal(10,3) DEFAULT NULL COMMENT 'Peso cru em kg (valor numérico)',
  `peso_cozido` enum('BOM','REGULAR','RUIM') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `peso_cozido_valor` decimal(10,3) DEFAULT NULL COMMENT 'Peso cozido em kg (valor numérico)',
  `fator_coccao` enum('BOM','REGULAR','RUIM') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fator_coccao_valor` decimal(10,3) DEFAULT NULL COMMENT 'Fator de cocção (valor numérico)',
  `cor` enum('BOM','REGULAR','RUIM') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cor_observacao` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Observação breve sobre a cor',
  `odor` enum('BOM','REGULAR','RUIM') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `odor_observacao` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Observação breve sobre o odor',
  `sabor` enum('BOM','REGULAR','RUIM') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sabor_observacao` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Observação breve sobre o sabor',
  `aparencia` enum('BOM','REGULAR','RUIM') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `aparencia_observacao` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Observação breve sobre a aparência',
  `conclusao` text COLLATE utf8mb4_unicode_ci,
  `resultado_final` enum('APROVADO','APROVADO_COM_RESSALVAS','REPROVADO') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Resultado final da avaliação',
  `avaliador_id` int DEFAULT NULL,
  `aprovador_id` int DEFAULT NULL,
  `foto_embalagem` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `foto_produto_cru` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Foto do produto cru',
  `foto_produto_cozido` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Foto do produto cozido',
  `pdf_avaliacao_antiga` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Caminho/URL do PDF da avaliação antiga (obrigatório para reavaliações)',
...
CREATE TABLE `formas_pagamento` (
  ...
  `descricao` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `prazo_padrao` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Prazo padrão (ex: 30 dias, À vista)',
...
CREATE TABLE `pdf_templates` (
  `id` int NOT NULL,
  `nome` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nome do template',
  `descricao` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Descrição do template',
  `tela_vinculada` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tela onde o template será usado (ex: solicitacoes-compras, pedidos-compras)',
  `html_template` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'HTML do template com variáveis {{variavel}}',
  `css_styles` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'CSS adicional para o template',
...
CREATE TABLE `pedidos_compras` (
  `id` int NOT NULL,
  `numero_pedido` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Número sequencial do pedido (PC000001)',
  ...
  `fornecedor_nome` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Nome do fornecedor',
  `fornecedor_cnpj` varchar(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'CNPJ do fornecedor',
  `filial_id` int DEFAULT NULL COMMENT 'ID da filial',
  `filial_nome` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Nome da filial',
  `data_entrega_cd` date DEFAULT NULL COMMENT 'Data de entrega no CD',
  `semana_abastecimento` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Semana de abastecimento',
  `valor_total` decimal(15,2) DEFAULT '0.00' COMMENT 'Valor total do pedido',
  `status` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'em_digitacao',
  `observacoes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Observações gerais do pedido',
  `criado_por` int DEFAULT NULL COMMENT 'ID do usuário que criou',
  `criado_em` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `atualizado_em` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `forma_pagamento` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prazo_pagamento` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `filial_entrega_id` int DEFAULT NULL,
  `filial_faturamento_id` int DEFAULT NULL,
  `endereco_entrega` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `endereco_faturamento` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `justificativa` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `numero_solicitacao` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `filial_cobranca_id` int DEFAULT NULL,
  `endereco_cobranca` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `cnpj_faturamento` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cnpj_cobranca` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cnpj_entrega` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
...
CREATE TABLE `pedido_compras_itens` (
  ...
  `codigo_produto` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Código do produto',
  `nome_produto` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Nome do produto',
  `unidade_medida_id` int DEFAULT NULL COMMENT 'ID da unidade de medida',
  `unidade_medida` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Símbolo da unidade de medida',
  ...
  `observacao` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Observação específica do item',
  `criado_em` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `produto_comercial` (
  ...
  `nome_comercial` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `relatorio_inspecao` (
  ...
  `status` enum('DISPONIVEL','FINALIZADO') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'DISPONIVEL',
  `tipo_transporte` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Tipo de transporte: Baú, Baú Isotérmico, Baú Refrigerado, Sider, Grade Baixa, Graneleiro',
  `isento_material` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Isento de Material Estranho: Conforme, Não Conforme, N/A',
  `condicoes_caminhao` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Condições do Caminhão: Conforme, Não Conforme, N/A',
  `acondicionamento` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Acondicionamento: Conforme, Não Conforme, N/A',
  `condicoes_embalagem` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Condições da Embalagem: Conforme, Não Conforme, N/A',
...
CREATE TABLE `rotas` (
  ...
  `frequencia_entrega` enum('semanal','quinzenal','mensal','transferencia') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'semanal',
  `rota_coordenadas` json DEFAULT NULL COMMENT 'Coordenadas calculadas da rota (array de [lat, lng])',
  `rota_escolas_ids` json DEFAULT NULL COMMENT 'IDs das escolas da rota quando a rota foi calculada',
...
CREATE TABLE `unidades_escolares` (
  ...
  `lat` decimal(13,10) DEFAULT NULL COMMENT 'Latitude da unidade escolar',
  `long` decimal(14,10) DEFAULT NULL COMMENT 'Longitude da unidade escolar',

...
const NecessidadeModalCabecalho = ({
  ...
  return (
    <div className="bg-gray-50 p-4 rounded-lg transition-opacity duration-300">
      ...
      {/* Filtros principais: Escola e Grupo */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        ...
        <div>
          <SearchableSelect
            ...
            onChange={(value) => onInputChange('grupo_id', value)}
      ...
      {/* Filtros de Ano, Mês e Semana de Consumo */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 border-t pt-4">
        ...
        <div>
          <SearchableSelect
            ...
            value={formData.data}
            onChange={(value) => onInputChange('data', value)}

      ...
      <div className="bg-green-50 border-b border-gray-200 p-4 rounded-t-lg">
        <div className="flex justify-between items-center">
          <div>
            <h3 className="text-lg font-semibold text-green-800 flex items-center">
              ...
              Processadas ({necessidadesFiltradas.length} de {necessidades.length})
            </h3>
            <p className="text-green-600 text-sm mt-1">
              Necessidades com substituição confirmada pela logística (conf log) ou já impressas (impressao)
            </p>
          </div>
          ...
          {necessidadesFiltradas.length > 0 && (
            <div className="flex gap-2">
              <button
                ...
                title="Exportar necessidades processadas em PDF"
              >
              ...
              <button
                ...
                title="Exportar necessidades processadas em Excel"
              >
        ...
        <div className="mt-3">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Buscar por escola, nutricionista, produto, grupo..."
              value={busca}
              onChange={(e) => {
      ...
      <div className="overflow-x-auto">
        {loading ? (
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {necessidadesPaginadas.map((necessidade, index) => (
                  <tr key={`processada-${necessidade.id || index}-${necessidade.escola_id || index}-${necessidade.produto_id || index}-${index}`} className="hover:bg-green-50">
                    {modoVisualizacao === 'consolidado' ? (
                      <>
          ...
          <div className="text-center py-12 text-gray-500">
            ...
            <p>Nenhuma necessidade processada encontrada</p>
            {!temFiltrosAtivos && (
...
export default TabelaProcessadas;

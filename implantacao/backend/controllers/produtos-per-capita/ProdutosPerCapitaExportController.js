...
class ProdutosPerCapitaExportController {
  ...
  static async exportarXLSX(req, res) {
    try {
      ...
      { header: 'Parcial Manhã', key: 'per_capita_parcial_manha', width: 15 },
      { header: 'Parcial Tarde', key: 'per_capita_parcial_tarde', width: 15 },
      ...
      produtos.forEach(prod => {
        ws.addRow({
          ...
          classe: prod.classe,
          per_capita_parcial_manha: prod.per_capita_parcial_manha || 0,
          per_capita_parcial_tarde: prod.per_capita_parcial_tarde || 0,
    ...
    try {
      ...
      produtos.forEach((prod, index) => {
        ...
        const data = [
          ...
          prod.subgrupo || 'N/A',
          prod.classe || 'N/A',
          parseFloat(prod.per_capita_parcial_manha || 0).toFixed(3),
          parseFloat(prod.per_capita_parcial_tarde || 0).toFixed(3),

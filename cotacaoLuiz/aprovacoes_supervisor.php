...
if (!isset($_SESSION['usuario']) || !userCan('aprovacoes_supervisor', 'visualizar')) {
...
// Modificar a consulta para buscar apenas cotações aguardando aprovação do supervisor
$query = "SELECT 
    c.*, 
...
ORDER BY 
    CASE 
        WHEN c.status = 'aguardando_aprovacao_supervisor' THEN 1
        WHEN c.status = 'renegociacao' THEN 2
        ELSE 3
    END,
    c.data_criacao DESC";
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/aprovacoes_supervisor.css">
...
<body>
            ...
            <div class="filtros">
                <div class="filtro-grupo">
                    ...
                    <select id="filtro-status">
                        ...
                        <option value="aguardando_aprovacao_supervisor" selected>Aguardando Análise do Supervisor</option>
                ...
                <div class="filtro-grupo">
                    ...
                    <select id="filtro-comprador">
                        <option value="">Todos</option>
                        <?php
                        $compradores = $conn->query("SELECT DISTINCT u.id, u.nome FROM usuarios u JOIN cotacoes c ON u.id = c.usuario_id WHERE c.status IN ('aguardando_aprovacao_supervisor', 'renegociacao') ORDER BY u.nome")->fetchAll(PDO::FETCH_ASSOC);
    ...
    <?php include 'includes/modal_aprovacoes_supervisor.php'; ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function atualizarContadoresCards() {
            ...
            document.getElementById('aguardando-aprovacao-count').textContent = contadores['aguardando_aprovacao_supervisor'];
        ...
        cards.forEach((card, index) => {
            ...
            card.addEventListener('click', function() {
                const statusMap = {
                    0: 'aguardando_aprovacao_supervisor',
                    1: 'renegociacao'
                };

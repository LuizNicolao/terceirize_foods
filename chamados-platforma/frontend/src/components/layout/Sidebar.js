...
// Agrupamento dos itens do menu - apenas o que é usado no sistema de chamados
const menuGroups = [
  {
    title: 'Principal',
    items: [
  ...
  },
  {
    title: 'Gestão',
    items: [
      { path: '/chamados', icon: FaTicketAlt, label: 'Chamados', screen: 'chamados' },
    ]
  },
  {
    title: 'Administração',

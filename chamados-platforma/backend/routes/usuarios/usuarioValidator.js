...
const userValidations = {
  create: [
    ...
    body('tipo_de_acesso')
      ...
      .custom((value) => {
        return ['administrador', 'supervisor', 'tecnico', 'usuario'].includes(value);
      })
      .withMessage('Tipo de acesso inválido. Deve ser: administrador, supervisor, tecnico ou usuario'),

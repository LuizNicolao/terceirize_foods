...
import { FaEye, FaClock, FaExchangeAlt, FaUser, FaMapMarkerAlt, FaShoppingCart } from 'react-icons/fa';
      ...
      <div className="bg-white rounded-lg shadow-md p-8">
        <div className="text-center">
          ...
          <p className="text-gray-500">
            Não há cotações aguardando análise do supervisor no momento.
          </p>
        </div>
      </div>
    );
            ...
            {cotacoes.map((cotacao) => (
              <tr key={cotacao.id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  <button
                    onClick={() => handleAnalysisClick(cotacao)}

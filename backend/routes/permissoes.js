...
const PERMISSOES_PADRAO = {
  administrador: {
    I: {
      ...
      almoxarifados: { visualizar: true, criar: false, editar: false, excluir: false },
    ...
    II: {
      ...
      almoxarifados: { visualizar: true, criar: true, editar: true, excluir: false },
    ...
    III: {
      ...
      almoxarifados: { visualizar: true, criar: true, editar: true, excluir: true },
      cotacao: { visualizar: true, criar: true, editar: true, excluir: true },
  ...
  administrativo: {
    ...
    II: {
      ...
      almoxarifados: { visualizar: true, criar: true, editar: false, excluir: false },

      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 sm:p-10 w-full max-w-md mx-4 animate-fadeInUp">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full px-3 py-3 pl-10 pr-3 border-2 rounded-lg text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-green-200 focus:outline-none transition-colors ${
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full px-3 py-3 pl-10 pr-12 border-2 rounded-lg text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-green-200 focus:outline-none transition-colors ${
          ...
          <button
            ...
            className={`w-full font-semibold py-3 px-4 rounded-lg transition-colors disabled:cursor-not-allowed flex items-center justify-center ${
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500">
            © 2024 MySQL Backup Web. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </div>

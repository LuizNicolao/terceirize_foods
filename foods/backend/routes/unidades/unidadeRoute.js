...
router.get('/export/xlsx', checkScreenPermission('unidades', 'visualizar'), UnidadesController.exportarXLSX);
router.get('/export/pdf', checkScreenPermission('unidades', 'visualizar'), UnidadesController.exportarPDF);

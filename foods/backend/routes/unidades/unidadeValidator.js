/**
 * Validações específicas para Unidades de Medida
...
// Criar handler de validação específico para unidades
const handleValidationErrors = createEntityValidationHandler('unidades');

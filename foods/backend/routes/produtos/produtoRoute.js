...
router.get('/export/xlsx', checkScreenPermission('produtos', 'visualizar'), ProdutosController.exportarXLSX);
router.get('/export/pdf', checkScreenPermission('produtos', 'visualizar'), ProdutosController.exportarPDF);

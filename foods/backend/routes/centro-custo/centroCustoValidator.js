/**
 * Validações específicas para Centro de Custo
...
// Criar handler de validação específico para centro_custo
const handleValidationErrors = createEntityValidationHandler('centro_custo');

/**
 * Utilitário para geração de códigos de vitrine no Backend
 ...
 */
const gerarCodigoVitrine = (tipo, id) => {
 ...
 */
const extrairIdDoCodigoVitrine = (codigoVitrine) => {
 ...
 */
const identificarTipoPorCodigoVitrine = (codigoVitrine) => {
  if (!codigoVitrine || typeof codigoVitrine !== 'string') return null;
 ...
 */
const validarCodigoVitrine = (codigoVitrine) => {
 ...
 */
const gerarCodigoProdutoOrigem = (id) => {
 ...
 * @returns {string} Código de vitrine
 */
const gerarCodigoProdutoGenerico = (id) => {
 ...
 * @returns {string} Código de vitrine
 */
const gerarCodigo = (tipo, id) => {
  return gerarCodigoVitrine(tipo, id);
};

module.exports = {
  gerarCodigoVitrine,
  extrairIdDoCodigoVitrine,
  identificarTipoPorCodigoVitrine,
  validarCodigoVitrine,
  buscarPorCodigo,
  gerarCodigoGrupo,
  gerarCodigoSubgrupo,
  gerarCodigoClasse,

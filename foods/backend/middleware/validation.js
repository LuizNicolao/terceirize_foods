 ...
 * 
 * NOTA: As validações específicas das seguintes entidades foram movidas para seus próprios arquivos:
 * - usuarios -> routes/usuarios/usuarioValidator.js
 * - veiculos -> routes/veiculos/veiculoValidator.js
 * - rotas -> routes/rotas/rotaValidator.js
 * - unidades-escolares -> routes/unidades_escolares/unidadeEscolarValidator.js
 * - motoristas -> routes/motoristas/motoristaValidator.js
 * - ajudantes -> routes/ajudantes/ajudanteValidator.js
 */

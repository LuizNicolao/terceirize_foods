 ...
 * Configura o multer para upload de arquivos Excel
 */
...
const fileFilter = (req, file, cb) => {
  ...
  if (allowedExtensions.includes(fileExtension)) {
    ...
    cb(new Error('Tipo de arquivo não suportado. Apenas arquivos Excel (.xlsx, .xls) são permitidos.'), false);
  }
};
...
// Middleware para upload de planilhas Excel
const uploadExcel = upload.single('planilha');

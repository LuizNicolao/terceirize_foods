...
const ImportNotasFiscaisModal = ({ isOpen, onClose, onImportSuccess }) => {
  ...
  const handleDownloadModelo = async () => {
    try {
      setLoading(true);
      const response = await notaFiscalService.baixarModelo();
      ...
      if (response.success) {
        ...
        link.href = url;
        link.setAttribute('download', 'modelo_notas_fiscais.xlsx');
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const response = await notaFiscalService.importar(formData);
      ...
      <div className="space-y-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
            ...
            <li>A planilha possui duas abas: <strong>"Notas Fiscais"</strong> e <strong>"Itens"</strong></li>
        ...
        {resultado && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            ...
            <div className="text-sm text-green-800 space-y-1">
              <p>• {resultado.importados} notas fiscais importadas</p>
              <p>• {resultado.atualizados} notas fiscais atualizadas</p>
...
export default ImportNotasFiscaisModal;

...
const CKEditor = ({ 
  ...
  // Placeholder simples enquanto CKEditor está comentado
  ...
  // COMENTADO TEMPORARIAMENTE - Retorna textarea simples
  // return (
  //   <>
  //     <style>{`
  ...
  // Placeholder temporário - textarea simples
  return (
    <div className={`ckeditor-wrapper ${className}`} style={{ minHeight: `${height}px` }}>
      <textarea
        value={value || ''}
        ...
        style={{ minHeight: `${height}px` }}
        placeholder="CKEditor temporariamente desabilitado"
      />
    </div>
  );
};

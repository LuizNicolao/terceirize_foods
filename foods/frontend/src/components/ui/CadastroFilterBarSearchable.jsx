  ...
  return (
    <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
        {/* Campo de busca - ocupa toda a largura em mobile, 2 colunas em md, 3 em lg, 4 em xl */}
        <div className="md:col-span-2 lg:col-span-3 xl:col-span-4 relative">
        ...
        {/* Botões de ação - ocupa toda a largura em mobile, 2 colunas em md, 3 em lg, 4 em xl */}
        <div className="md:col-span-2 lg:col-span-3 xl:col-span-4 flex gap-2 justify-end">
          {onClear && (
            <button 
              onClick={onClear} 

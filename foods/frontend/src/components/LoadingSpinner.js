...
const LoadingSpinner = ({ inline = false, text = '' }) => {
  ...
  const spinnerClasses = inline
    ? 'w-8 h-8 border-2 border-green-200 border-t-green-500 rounded-full animate-spin'
    : 'w-12 h-12 border-4 border-gray-300 border-t-green-500 rounded-full animate-spin';

...
const TiposCardapio = () => {
  ...
  const { handleExportXLSX, handleExportPDF } = useExport(TiposCardapioService);
    ...
    <div className="p-3 sm:p-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-3 sm:gap-4">
        ...
        <div className="flex gap-2 sm:gap-3">
          ...
          {canCreate('tipos_cardapio') && (
            <Button onClick={handleAddTipo} size="sm">
      ...
      {/* Estatísticas */}
      <TiposCardapioStats estatisticas={estatisticas} />

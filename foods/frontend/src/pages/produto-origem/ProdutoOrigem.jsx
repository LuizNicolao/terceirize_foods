...
const ProdutoOrigem = () => {
  ...
  const { handleExportXLSX, handleExportPDF, handlePrintPDF } = useExport(ProdutoOrigemService);
  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      <ProdutoOrigemActions
        ...
        onPrintPDF={() => handlePrintPDF({ search: searchTerm, status: statusFilter })}
      ...
      <AuditModal
        ...
        title="Auditoria - Produtos Origem"
      />
    </div>
  );
};
